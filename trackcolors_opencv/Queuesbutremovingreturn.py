...
red_thread = threading.Thread(target=detect_color, args=(
    np.array([165, 100, 100], np.uint8), np.array([185, 255, 255], np.uint8), "Red Color", framesQ))
green_thread = threading.Thread(target=detect_color, args=(
    np.array([70, 100, 100], np.uint8), np.array([85, 255, 255], np.uint8), "Green Color", framesQ))
blue_thread = threading.Thread(target=detect_color, args=(
    np.array([105, 100, 100], np.uint8), np.array([120, 255, 255], np.uint8), "Blue Color", framesQ))
yellow_thread = threading.Thread(target=detect_color, args=(
    np.array([35, 100, 100], np.uint8), np.array([43, 255, 255], np.uint8), "Yellow Color", framesQ))
webcam_thread = threading.Thread(target=readWebcam, args=(
    "Red Color", framesQ))
drawframe_thread = threading.Thread(target=drawFrame, args=(
